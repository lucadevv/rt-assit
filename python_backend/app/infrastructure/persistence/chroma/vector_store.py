"""Chroma vector store for embeddings (RAG-future, not used by current flow).

Kept verbatim from the previous implementation. F4 RAG path will wire this
through a VectorStore port + use case once we add it."""
import os
import logging
